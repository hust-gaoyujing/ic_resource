...
# read the design
analyze -format verilog $UNMAPPED_DIR/rxblock.v

elaborate rxblock

current_design rxblock
link
...
write -format db -hierarchy -output $MAPPED_DIR/rxblock.db
write -format verilog -hierarchy -output $MAPPED_DIR/rxblock.v
write_sdf $MAPPED_DIR/rxblock.sdf
write_sdc $MAPPED_DIR/rxblock.sdc
#write_constraints -format sdf-v2.1 -hierarchy -output $MAPPED_DIR/rxblock.sdf
write_constraints -format sdf-v2.1 -max_nets 0.05 -max_path_timing -max_paths 1 -hierarchy -output $MAPPED_DIR/rxblock.sdf